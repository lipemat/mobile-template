...
class MobileTemplate {
	...
	function settingsPage(){
		...
		<form method="post" action="options.php">
			...
			<p class="description">This will display the mobile theme on desktops when logged in and test mode is on.
			</p>
			...
			<br>
			Device's Theme to Show:
			<select name="mobile_template_show_device">
			...
			<p class="description">With test mode enabled this is the mimimum user role who will see the mobile theme.
			</p>
			<select name="mobile_template_capability">
				...
				<option value="manage_options" <?php selected( 'manage_options', $capability ); ?>>Administrator
				</option>
			</select>
			<p>&nbsp;</p>
